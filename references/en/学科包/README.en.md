...
> Before teaching, the tutor must read this README and pick a pack; if none fits, generate one on the spot from [`_自定义学科包模板.md`](../../学科包/_自定义学科包模板.md).
> Chinese version: [`README.md`](../../学科包/README.md)
...
| File | Coverage |
|---|---|
| [`编程.md`](../../学科包/编程.md) | All kinds of programming languages, algorithms, engineering practice |
| [`语言.md`](../../学科包/语言.md) | Foreign-language learning such as English and Japanese |
| [`文科.md`](../../学科包/文科.md) | History, politics, philosophy, law, literature |
| [`理科.md`](../../学科包/理科.md) | Math, physics, chemistry, biology |
| [`考试.md`](../../学科包/考试.md) | Exam-oriented tracks such as postgraduate entrance, civil service, certification |
...
1. Copy [`_自定义学科包模板.md`](../../学科包/_自定义学科包模板.md) to `<subject-name>.md`.
2. Fill in 5 things:
