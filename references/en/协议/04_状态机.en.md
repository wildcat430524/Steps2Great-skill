...
> Invariants are mechanically checked by [`../_tools/validate-state.mjs`](../../../scripts/validate-state.mjs) — violations get reported by a tool instead of relying on self-discipline.
> Chinese version: [`04_状态机.md`](../../协议/04_状态机.md)
...
| **`PLACEMENT`** | Placement test file created | Issuing per [`01_摸底剧本.md`](../../协议/01_摸底剧本.md), grading | Publishing formal lessons |
...
> The other 8 invariants have **no downgrade tier** — a violation is a failure.

> **Verdict**: any invariant failing at the **failure tier** → validation fails (exit code 1). Conflict precedence is in [`03_落档事件表.md`](../../协议/03_落档事件表.md) section 4.
...
| To learn | Read |
|---|---|
| Teaching rules and rhythm | [`00_导师协议.md`](../../协议/00_导师协议.md) |
| When to write which file | [`03_落档事件表.md`](../../协议/03_落档事件表.md) |
| How placement questions are written | [`01_摸底剧本.md`](../../协议/01_摸底剧本.md) |
| Document skeletons for a new lesson | [`02_新课模板.md`](../../协议/02_新课模板.md) |
