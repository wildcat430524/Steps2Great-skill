...
> Chinese version: [`01-五分钟上手.md`](../../教程/01-五分钟上手.md)
...
Detailed comparison and per-tool install steps → [`02-各工具接入指南.md`](../../教程/02-各工具接入指南.md)
...
4. Try a different tool (see [`02-各工具接入指南.md`](../../教程/02-各工具接入指南.md))
...
- Want to know how to install each tool specifically → [`02-各工具接入指南.md`](../../教程/02-各工具接入指南.md)
- Want to know how this project is designed → [`03-设计说明.md`](../../教程/03-设计说明.md)
