...
见 [`../../教程/01-五分钟上手.md`](../../教程/01-五分钟上手.md) 与
...
AI 会读 [`../../AGENTS.md`](../../../SKILL.md) → 发现 `我的学习/00-学习档案.md` 是空的 → 进入**需求收集**。
...
AI 按 [`../../协议/01_摸底剧本.md`](../../协议/01_摸底剧本.md) 出题，总题量 5–8 题封顶，**每轮只发 1–3 题**（与上课节奏一致）。
